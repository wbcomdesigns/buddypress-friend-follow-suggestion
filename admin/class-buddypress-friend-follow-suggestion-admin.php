...
class Buddypress_Friend_Follow_Suggestion_Admin {
	...
	/**
		...
		public function wbcom_hide_all_admin_notices_from_setting_page() {
			$wbcom_pages_array  = array( 'wbcomplugins', 'wbcom-plugins-page', 'wbcom-support-page', 'bffs-settings', 'wbcom-license-page' );
			...
			<div class="bffs-header">
				<div class="wbcom_admin_header-wrapper">
						<div id="wb_admin_plugin_name">
							...
							<?php /* translators: %s: */ ?>
							<span><?php printf( esc_html__( 'Version %s', 'buddypress-friend-follow-suggestion' ), esc_attr( BFFS_PLUGIN_VERSION ) ); ?></span>
						</div>
