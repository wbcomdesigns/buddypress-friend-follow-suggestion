...
if ( ! class_exists( 'Wbcom_Admin_Settings' ) ) {
	...
	class Wbcom_Admin_Settings {
		...
		public function wbcom_admin_additional_pages() {
			add_submenu_page(
				'wbcomplugins',
				esc_html__( 'Components', 'buddypress-friend-follow-suggestion' ),
				esc_html__( 'Components', 'buddypress-friend-follow-suggestion' ),
				'manage_options',
				'wbcom-plugins-page',
			...
			add_submenu_page(
				'wbcomplugins',
				esc_html__( 'Themes', 'buddypress-friend-follow-suggestion' ),
				esc_html__( 'Themes', 'buddypress-friend-follow-suggestion' ),
				'manage_options',
				'wbcom-themes-page',
			...
			add_submenu_page(
				'wbcomplugins',
				esc_html__( 'Support', 'buddypress-friend-follow-suggestion' ),
				esc_html__( 'Support', 'buddypress-friend-follow-suggestion' ),
				'manage_options',
				'wbcom-support-page',
