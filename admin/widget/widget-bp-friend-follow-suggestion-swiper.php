...
class BP_Friend_Follow_Suggestion_Swiper_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		$name        = _x( '(Swiper) BuddyPress Friend Suggestion', 'widget name', 'buddypress-friend-follow-suggestion' );
		...
		parent::__construct(
			...
			array(
				...
				'classname'   => 'widget_bp_friend_suggestion_slider_widget buddypress widget',
			)
		);
	...
	public function widget( $args, $instance ) {
		...
		if ( bp_has_members( $members_args ) && ! empty( $matched_members ) ) :    
			...
			<div id="<?php echo esc_attr( 'bp-friend-swiper-slider-'.rand() ); ?>" class="bffs_swiper_layout_wrapper bffs_swiper_<?php echo esc_attr( $settings['layout'] ); ?> bp-friend-swiper-no-slider">
